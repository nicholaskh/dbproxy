...
func main() {
	...
	if err = initXLog(cfg.LogOutput, cfg.LogPath, cfg.LogFileName, cfg.LogLevel, cfg.Service, cfg.LogFormat); err != nil {
...
func initXLog(output, path, filename, level, service, format string) error {
