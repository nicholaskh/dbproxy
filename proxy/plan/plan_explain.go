...
// Size implement Plan
func (p *ExplainPlan) SetElapsedTables([]string) int {
	return 1
}

func (p *ExplainPlan) GetElapsedTables() []string {
	return nil
}

func (p *ExplainPlan) SetNodesToBeRecycled(nodes []ast.Node) {
	return
}

func (p *ExplainPlan) RecycleNodes() {
	return
}
