...
type Namespace struct {
	...
	ForceMaster      bool              `json:"force_master"` // true：主 false:非主
	MasterDCOrigin   bool              `json:"master_dc_origin"`
	MasterDC         bool              `json:"master_dc"`
	...
	DcDelayMS        int               `json:"dc_delay_ms"`
}

func (n *Namespace) UnmarshalJSON(b []byte) error {
	type Namespace2 Namespace
	n2 := Namespace2{
		MasterDC: true,
	}
