...
%type	<statement>
	...
	RollbackToStmt			"ROLLBACK TO statement"
...
%type   <item>
	...
	LengthString		"Field length string(uint64)"
...
| "ROLE" | "ROLLBACK" | "RELEASE" | "SAVEPOINT" | "SESSION" | "SIGNED" | "SNAPSHOT" | "START" | "STATUS" | "SUBPARTITIONS" | "SUBPARTITION" | "TABLES" | "TABLESPACE" | "TEXT" | "THAN" | "TIME" %prec lowerThanStringLitToken
...
|	builtinCount '(' '*' ')'  OptWindowingClause
	{
        args := []ast.ExprNode{&ast.WildCardExpr{}}
		if $5 != nil {
