...
type Logger interface {
	...
	Error(format string, a ...interface{}) (err error)
	...
	Errorx(logID, format string, a ...interface{}) (err error)
...
// Error log warn message.
func Error(format string, a ...interface{}) (err error) {
	return logger.Error(format, a...)
}

// Errorx log warn message.
func Errorx(logID, format string, a ...interface{}) (err error) {
	return logger.Errorx(logID, format, a...)
}
