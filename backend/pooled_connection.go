...
// RollbackTo wrapper of direct connection, rollbackTo savepoint 
func (pc *PooledConnection) RollbackTo(savepoint string) error {
	return pc.directConnection.RollbackTo(savepoint)
}

// Savepoint wrapper of direct connection, make savepoint 
func (pc *PooledConnection) Savepoint(savepoint string) error {
